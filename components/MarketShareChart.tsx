  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16 w-full py-8">
      ...
      <div className="flex items-center justify-center">
          <div className="w-12 h-12 rounded-full border-2 border-[#555555] flex items-center justify-center text-[#555555]">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 lg:rotate-0 rotate-90" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
